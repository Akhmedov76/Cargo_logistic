...
class DeliveryRequest(TimeModelMixin, models.Model):
    ...
    services = models.ForeignKey('ServicesModel', on_delete=models.CASCADE, blank=True)
...
class DeliveryForDrivers(TimeModelMixin, models.Model):
    ...
    body_volume = models.DecimalField(_('Volume'), max_digits=12, decimal_places=2, null=True)
